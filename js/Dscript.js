...
var users = {
	phineas: {
		username: '◈ hesam TooVinS',
		nameColor: 'hsl(345, 50%, 52%)',
		avatar: 'https://images-ext-1.discordapp.net/external/BzAEVTKkIHPDvVwzyUGwBXNDceRd_DyHwjRVgDzD9xg/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/556854910805737478/8e21575656e57c836449baf00885af15.webp'
	},
	paragon: {
		username: 'HAGH GOO',
		nameColor: 'hsl(212, 51%, 59%)',
		bot: true,
		avatar: 'https://images-ext-1.discordapp.net/external/1dVlpMtq4B5ASGZsGNmE246sTnosWCSu7hXbxTBLF1M/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/904273891206254623/03622c267d1cda3be0f7095acf62d695.webp?width=454&height=454'
	}
};
...
var channelData = [{
	...
	messages: [{
		...
		embedData: {
			...
			pill: 'hsl(202, 35%, 68%)',
			color:`#00FF00`,
			thumb: `https://images-ext-2.discordapp.net/external/28TvSD7fnM8l3SQ4wCxT7kcVGIzvIMeCF5nIhM-u6FM/%3Fwidth%3D454%26height%3D454/https/images-ext-2.discordapp.net/external/PvcCCyhxWwlevEwkCcWVzbCaCYw10iX07XcvBI2-QMY/%253Fsize%253D1024/https/cdn.discordapp.com/avatars/904273891206254623/03622c267d1cda3be0f7095acf62d695.png`,
			fields: [{
				name: '-> /play',
				value: '▶️|Play a song.	'
			}, {
				...
				name: '-> /skip',
				value: '⏭|Skip your current playing song'
			}, {
				name: '-> /filters',
				value: '🌆 vaporwave,🌌 nightcore, 🎧 baseboost'
			}, {
				name: '-> /247',
				value: 'enable or disbale 24/7 bot in server voice'
			},
			{
				name: '-> and for more commnads',
				value: 'INVITE Bot '
			}]
		}
	}]
...
},
 {
	...
	messages: [{
		type: 'input',
		text: '/play Daste man nist',
		user: users.phineas
	}, {
		type: 'message',
		delay: 350,
		user: users.paragon,
		text: '🎶 | New song Added to queue: Shadmehr - Daste Man Nist OFFICIAL MUSIC',
		embedData: {
			title: '🎶 | Now Playing',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://images-ext-1.discordapp.net/external/qMDUVGKwYDBvhy5b5AAElZnm5uSZS0g-QadnBe3UsEo/https/img.youtube.com/vi/ihS52ehMiXs/mqdefault.jpg',
			fields: [{
				name: 'Now playing',
				value: 'Shadmehr Daste Man Nist OFFICIAL MUSIC '
			}, {
				name: '⌛  Duration',
				value: '3:43'
			}, {
				name: 'Music Link',
				value: 'https://www.youtube.com/watch?v=ihS52ehMiXs'
			}],
